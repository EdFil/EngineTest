...
//     auto it = std::remove(_applicationEventDelegates.begin(), _applicationEventDelegates.end(),
//     delegate); _applicationEventDelegates.erase(it, _applicationEventDelegates.end());
// }
