if(WIN32)
  ...
  file(INSTALL ${FLECS_RUNTIME_LIB} DESTINATION ${CMAKE_RUNTIME_OUTPUT_DIRECTORY})
elseif (UNIX AND NOT APPLE)
  set(FLECS_DIR ${CMAKE_CURRENT_LIST_DIR}/linux)
  set(FLECS_LIB ${FLECS_DIR}/lib/libflecs_static.a)
else()
